...
dk_data <- read.csv(file = 'data/dk_R_Subtype 1.csv')
aseg_data <- read.csv(file = 'data/aseg_R_Subtype 1.csv')
...
saveWidget(fig2, "html_3D/Subtype 0.html", selfcontained = F, libdir = "lib0")
